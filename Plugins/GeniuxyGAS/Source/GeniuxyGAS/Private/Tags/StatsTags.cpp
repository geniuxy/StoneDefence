...
namespace StatsTags
{
	UE_DEFINE_GAMEPLAY_TAG(Ge_Stats_Health_Full, "Ge.Stats.Health.Full");
	UE_DEFINE_GAMEPLAY_TAG(Ge_Stats_Health_Empty, "Ge.Stats.Health.Empty");
	UE_DEFINE_GAMEPLAY_TAG(Ge_Stats_Dead, "Ge.Stats.Dead");
	UE_DEFINE_GAMEPLAY_TAG(Ge_Stats_Energy_Full, "Ge.Stats.Energy.Full");
